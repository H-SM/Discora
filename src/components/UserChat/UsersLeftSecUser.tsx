...
const UsersLeftSecUser = () => {
  ...
  return (
    ...
    <div className='flex flex-col justify-start items-center gap-2overflow-y-auto overflow-x-hidden w-[15rem] h-[86.2vh] pt-4'>
      {userInfo == 2 ?
      <>
      ...
      :
      <div className='w-[14rem]  h-fit flex flex-col justify-center items-center pb-1  border-white/20'>
      <button className='w-[14rem] h-[2.5rem] flex gap-3 items-center focus:text-white active:text-white text-gray-400/80 justify-start hover:bg-white/5 active:bg-white/10 focus:bg-white/10 px-[2rem] rounded-md hover:cursor-pointer py-1'  onClick={() => setUserInfo(0)}>
      ...
      fill="currentColor"  width={"1.5rem"} height={"1.5rem"} className='mx-1'><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <rect width="16" height="16" id="icon-bound" fill="none"></rect> <path d="M10,1L3,9h4.5L6,15l7-8H8.5L10,1z"></path> </g></svg>
      ...
      <button>
      <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width={"1rem"} height={"1rem"} className="fill-current"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M6 12H18M12 6V18" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
      </button>
      </div>   
      <FriendListUser/>
      </div>
