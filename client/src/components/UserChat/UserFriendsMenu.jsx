...
const UserFriendsMenu = () => {
  return (
    <div className='bg-[#313338] h-full w-[120vh] flex flex-col justify-start items-center'>
      <div class="relative w-[116vh] mt-2"> 
        <input type="search" id="default-search" class="block w-full p-4 pe-10 text-sm text-gray-300/60 rounded-md text-[1rem] outline-none bg-[#1e1f22] h-[2.2rem] font-roboto" placeholder="Search"/>
